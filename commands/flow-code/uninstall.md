...
**Question 1:** "Remove flow-code from this project?"
- "Yes, uninstall"
- "Cancel"
...
For CLAUDE.md and AGENTS.md: if file exists, remove everything between `<!-- BEGIN FLOW-CODE -->` and `<!-- END FLOW-CODE -->` (inclusive). This is safe for the AI to execute.
